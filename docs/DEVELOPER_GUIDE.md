...
12. [Production Automation Scripts](#production-automation-scripts)
...
2. **Set up PostgreSQL Database**
    ...
    psql -U postgres -d AmmoP1DB -f sql/dbo.TaskActivity\ \(PostgreSQL\).sql
    psql -U postgres -d AmmoP1DB -f sql/dbo.DropdownValues\ \(PostgreSQL\).sql
    ```
...
- If network access stops working after reboot, run `.\update-wsl-port-forward.ps1` as Administrator
- See [WSL Port Forwarding Guide](../WSL_PORT_FORWARDING.md) for detailed troubleshooting
...
**Exporting to S3:**
```powershell
# See aws/export-logs-to-s3.ps1 for automated exports
cd aws
...
- [`../localdocs/CLOUDWATCH_LOGGING_GUIDE.md`](../localdocs/CLOUDWATCH_LOGGING_GUIDE.md) - Complete CloudWatch setup
- [`../localdocs/S3_LOG_ARCHIVAL_GUIDE.md`](../localdocs/S3_LOG_ARCHIVAL_GUIDE.md) - S3 archival configuration
- [`aws/HELPER_SCRIPTS_README.md`](../aws/HELPER_SCRIPTS_README.md) - Log export scripts
...
-- Performance index
CREATE INDEX idx_dropdownvalue_category ON "DropdownValue"("category");
```
...
**Documentation:**
- **[AWS Deployment README](../aws/README.md)** - Complete deployment guide
- **[Cloudflare on AWS Guide](../aws/CLOUDFLARE_ON_AWS.md)** - Integrated Cloudflare tunnel setup
- **[CloudWatch Logging Guide](../localdocs/CLOUDWATCH_LOGGING_GUIDE.md)** - Log monitoring and queries
- **[S3 Log Archival Guide](../localdocs/S3_LOG_ARCHIVAL_GUIDE.md)** - Long-term log storage
- **[IAM User Setup](../localdocs/IAM_USER_SETUP.md)** - AWS permissions configuration
...
**After WSL Restart:**
- WSL IP addresses change when WSL restarts
- Run `.\update-wsl-port-forward.ps1` as Administrator to update the IP
