...
2. **Fill in Task Details (all entries are required)**
   
   - **Task Date**: Click the calendar icon to select the date
   - **Client**: Choose the client from the dropdown
   - **Project**: Select the project you worked on
   - **Phase**: Pick the work phase (Development, Testing, etc.)
   - **Hours**: Enter time spent (use decimals like 2.5 for 2½ hours)
   - **Details**: Describe what you worked on
