...
# Cloudflare tunnel credentials (if using Cloudflare tunnel)
aws secretsmanager create-secret `
...
# Cloudflare tunnel configuration (if using Cloudflare tunnel)
aws secretsmanager create-secret `
...
**Note:** For detailed Cloudflare tunnel setup on AWS, see [CLOUDFLARE_ON_AWS.md](CLOUDFLARE_ON_AWS.md).
