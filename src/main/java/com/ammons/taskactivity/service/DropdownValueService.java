...
public class DropdownValueService {
    ...
    public List<String> getActiveValuesByCategory(String category) {
        return dropdownValueRepository
                ...
                .map(DropdownValue::getValue) // Transform each DropdownValue to its string value
                .collect(Collectors.toList()); // Collect results back to List<String>
    }
    ...
    public DropdownValue createDropdownValue(String category, String value) {
        ...
        if (dropdownValueRepository.existsByCategoryAndValueIgnoreCase(category.toUpperCase(),
                value)) {
    ...
    public DropdownValue updateDropdownValue(Long id, String value, Integer displayOrder,
        ...
        if (existing.isPresent()) {
            ...
            // Check for duplicate values within a category
            if (!dropdownValue.getValue().equalsIgnoreCase(value) && dropdownValueRepository
                    .existsByCategoryAndValueIgnoreCase(dropdownValue.getCategory(), value)) {
