...
public interface DropdownValueRepository extends JpaRepository<DropdownValue, Long> {
     ...
     */
    @Query("SELECT dropdownValue FROM DropdownValue dropdownValue WHERE dropdownValue.category = :category AND dropdownValue.isActive = true ORDER BY dropdownValue.displayOrder, dropdownValue.value")
     ...
     */
    @Query("SELECT dropdownValue FROM DropdownValue dropdownValue WHERE dropdownValue.category = :category ORDER BY dropdownValue.displayOrder, dropdownValue.value")
     ...
     */
    public boolean existsByCategoryAndValueIgnoreCase(String category, String value);
