...
class DropdownValueServiceTest {
    ...
    void setUp() {
        ...
        testDropdownValue.setRecId(1L);
        testDropdownValue.setCategory(TEST_CATEGORY);
        testDropdownValue.setValue(TEST_VALUE);
    ...
    class GetActiveValuesTests {
        ...
        void shouldGetActiveValuesByCategory() {
            // Given
            DropdownValue value1 = new DropdownValue("CLIENT", "Client 1", 1, true);
            DropdownValue value2 = new DropdownValue("CLIENT", "Client 2", 2, true);
            ...
            assertThat(result).containsExactly("Client 1", "Client 2");
    ...
    class GetAllValuesTests {
        ...
        void shouldGetAllValuesByCategory() {
            // Given
            DropdownValue activeValue = new DropdownValue("PROJECT", "Active Project", 1, true);
            DropdownValue inactiveValue =
                    new DropdownValue("PROJECT", "Inactive Project", 2, false);
            ...
            // Then
            assertThat(result).hasSize(2);
            assertThat(result.get(0).getValue()).isEqualTo("Active Project");
            assertThat(result.get(0).getIsActive()).isTrue();
            assertThat(result.get(1).getValue()).isEqualTo("Inactive Project");
    ...
    class CreateDropdownValueTests {
        ...
        void shouldCreateDropdownValueSuccessfully() {
            ...
            expectedValue.setRecId(1L);
            expectedValue.setCategory(category);
            expectedValue.setValue(value);
            expectedValue.setDisplayOrder(maxOrder + 1);
            expectedValue.setIsActive(true);

            when(dropdownValueRepository.existsByCategoryAndValueIgnoreCase(category, value))
                    .thenReturn(false);
            ...
            verify(dropdownValueRepository).existsByCategoryAndValueIgnoreCase(category, value);
        ...
        void shouldThrowExceptionForDuplicateValue() {
            ...
            assertThatThrownBy(() -> dropdownValueService.createDropdownValue(category, value))
                    ...
                    .hasMessage("Value 'Existing Client' already exists for category CLIENT");
    ...
    class UpdateDropdownValueTests {
        ...
        void shouldUpdateDropdownValueSuccessfully() {
            ...
            when(dropdownValueRepository.existsByCategoryAndValueIgnoreCase(TEST_CATEGORY,
                    newValue)).thenReturn(false);
            ...
            verify(dropdownValueRepository).existsByCategoryAndValueIgnoreCase(TEST_CATEGORY,
                    newValue);
            verify(dropdownValueRepository).save(any(DropdownValue.class));
        }
        ...
        void shouldUpdateWithoutDuplicateCheckWhenValueUnchanged() {
            ...
            assertThat(result).isNotNull();
            verify(dropdownValueRepository).findById(id);
            verify(dropdownValueRepository, never()).existsByCategoryAndValueIgnoreCase(any(),
                    any());
            verify(dropdownValueRepository).save(any(DropdownValue.class));
        }
    ...
    class ToggleActiveStatusTests {
        ...
        void shouldToggleActiveStatusFromTrueToFalse() {
            ...
            toggledValue.setRecId(id);
            toggledValue.setCategory(TEST_CATEGORY);
            toggledValue.setValue(TEST_VALUE);
    ...
    class GetDropdownValueByIdTests {
        ...
        void shouldGetDropdownValueById() {
            ...
            assertThat(result.get()).isEqualTo(testDropdownValue);
            verify(dropdownValueRepository).findById(id);
        }
